...
const CONTENT = {
  ...
  lectureOverview: {
    ...
    items: [
      ...
      {
        label: "내용",
        text: ["Gemini · Google Flow · Canva · 맞춤설정 · 업무활용 · 배경화면제작"]
      },
      {
        label: "방식",
  ...
  /* ── 05. 강의 교안 / 실습 결과물 / 후기 ────────────────── */
  lectureMaterials: [
    { src: "assets/lectures/material-ax-01.png?v=4" },
    { src: "assets/lectures/material-ax-02.png?v=4" },
    { src: "assets/lectures/material-west-01.png?v=4" },
    { src: "assets/lectures/material-west-02.png?v=4" }
  ],
  lecturePractice: [
  ...
  lectureReviewCards: [
    ...
    "강사님 덕분에 재미나이라는 어플을 처음 사용해봤는데 앞으로도 유익하게 잘 사용될 것 같습니다. 새롭고 재미있는 강의가 되었습니다 !",
  ...
  lectureReviewHighlights: [
    ["AI로 홍보자료를 만들고 싶으나 혼자서 힘든 부분을", "해소할 수 있었던"],
    ["집중이 잘되고 유익한 강의", "듣는 내내 좋았습니다"],
    ["지사 돌아가서 어떻게 활용하면 좋을지 아이디어 얻고 갑니다 !"],
    ["AI는 그냥 궁금한거 물어보기만 했지 이런식으로 활용할 줄 몰랐는데"],
    ["재미나이라는 어플을 처음 사용", "유익하게 잘 사용될 것"],
    ["ai 멀고도 험한길이라는 생각이 순삭바뀜.", "아이디어를 활용할수 있는 수단"],
    ["대전서부지사 연예인"]
  ],
